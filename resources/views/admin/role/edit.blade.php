        ...
        <div class="col-sm-8 m-auto">
            <div class="mi-card">
                ...
                <div class="mi-header warning">
                    <!--mi card header started-->EDIT ROLE
                </div>
                                        ...
                                        <div class="mi-body d-flex justify-content-around">
                                            @foreach ($authItems as $route=>$item)
                                                <div class="form-check">
                                                    <input class="form-check-input" name="access_item[]" type="checkbox" {{ in_array($route,$accessItems)?'checked':'' }} value="{{ $route }}" id="{{ $item }}">
                                        ...
                                        <div class="mi-header text-dark text-uppercase">Other pages</div>
                                            <div class="mi-body d-flex justify-content-around">
                                                @foreach ($otherPages as $pages)
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="access_item[]" type="checkbox" value="{{ $pages->route }}" id="{{ $pages->name }}" {{ in_array($pages->route,$accessItems)?'checked':'' }}>
